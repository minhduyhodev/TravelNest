...
function createBaseDraft(serviceType, serviceName, location, priceAmount) {
  return {
    serviceType,
    serviceName,
    location,
...
export function createHotelBookingDraft(hotel) {
  return {
    ...createBaseDraft("HOTEL", hotel.name, hotel.location, hotel.priceFrom),
...
export function createTourBookingDraft(tour) {
  return {
    ...createBaseDraft("TOUR", tour.name, tour.location, tour.priceFrom),
    guestCount: 2,
...
export function createRestaurantBookingDraft(restaurant) {
  return {
    ...createBaseDraft("RESTAURANT", restaurant.name, restaurant.location, restaurant.priceFrom),
